...
import net.runelite.client.plugins.deecat.dconeclick.comparables.misc.Compost;
...
import net.runelite.client.plugins.deecat.dconeclick.comparables.misc.Herbtar;
import net.runelite.client.plugins.deecat.dconeclick.comparables.misc.Seeds;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Birdhouses;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Bones;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.DarkEssence;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Darts;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Firemaking;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Karambwans;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Runes;
import net.runelite.client.plugins.deecat.dconeclick.comparables.skilling.Tiara;
