package net.runelite.client.plugins.deecat.dconeclick.comparables;
...
import net.runelite.client.plugins.deecat.dconeclick.DcOneClickPlugin;
...
public abstract class ClickCompare
{
	...
	@Nullable
	@Setter
	protected DcOneClickPlugin plugin;
